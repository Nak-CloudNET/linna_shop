...
class Pos extends MY_Controller
{
    ...
    function register_report($user_id = NULL, $rdate = NULL, $id = NULL, $total_cash = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->pos_model->closeRegister($rid, $user_id, $data)) {
            ...
            $user_close_register    = $this->pos_model->closeRegisterData($id);
            ...
            $this->data['error']            = (validation_errors() ? validation_errors() : $this->session->flashdata('error'));
            $this->data['ccsales']          = $this->pos_model->getRegisterCCSales($register_open_time, $user_register->user_id, $register_close_time);
            $this->data['cashsales']        = $this->pos_model->getRegisterCashSales($register_open_time, $user_register->user_id, $register_close_time);
            ...
            $this->data['user_id']          = $user_register->user_id;
