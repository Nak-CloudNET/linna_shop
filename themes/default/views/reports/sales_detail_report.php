                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed table-striped">
                        ...
                        if(count($sales) > 0){
                            foreach($sales as $key => $sale){
                                ...
                                $usings_stock = $this->db->query("SELECT
																	...
																	LEFT JOIN erp_sales ON erp_sales.so_id = erp_sale_order.id																	
                                ...
                                if($sale->type == 1 || $sale->type == 3){
                                    ...
                                    $s_gross_margin=$s_e_total-$s_total;
                                    $html .="<tr>
														<td class='right' colspan='11'>".lang("total_gross_margin")." : </td>
														<td></td>
														<td class='text-right'></td>
                                    ...
                                    $total_all_gross_margin+=$s_gross_margin;
                                }else{
                                ...
                                <tr style="font-weight:bold;">
                                    ...
                                    <?php if ($Owner || $Admin || $GP['products-cost']) { ?>
                                        <td class="right"><?=$this->erp->formatMoney($sub_totals)?></td>
                                    <?php } ?>
                                </tr>
                        ...
                        <tr>
                            ...
                            <th class="right" style="color:#0586ff"></th>
                            <?php if ($Owner || $Admin || $GP['products-cost']) { ?>
                                <th class="right" style="color:#0586ff"><?= $this->erp->formatMoney($total_all_gross_margin); ?></th>
                            <?php } ?>
                        </tr>
