                                                        ...
                                                        <?php } ?>                                                            
                                                                <li class="dropdown hidden-sm">
                                                                    ...
                                                                    if (!empty($payment_customer_alert_num)) { ?>
                                                                        <li>
                                                                            <a href="<?= site_url('sales/?d='. date('Y-m-d', strtotime($payment_customer_alert_num->date))) ?>" class="">
                                                                                <span class="label label-danger pull-right" style="margin-top:3px;"><?= $payment_customer_alert_num; ?></span>
                                                                    ...
                                                                    if (!empty($payment_supplier_alert_num)) { ?>
                                                                        <li>
                                                                            <a href="<?= site_url('purchases/?d='. date('Y-m-d', strtotime($payment_supplier_alert_num->date))) ?>" class="">
                                                                                <span class="label label-danger pull-right" style="margin-top:3px;"><?= $payment_supplier_alert_num; ?></span>
            ...
            <div class="row" id="main-con">
                <div id="sidebar-left" class="col-lg-2 col-md-2">
                    <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                        ...
                        <?php } else { ?>
							<?php if ($GP['products-index'] || $GP['product_items_convert'] || $GP['products-return_list'] || $GP['products-print_barcodes'] || $GP['products-adjustments'] || $GP['products-list_using_stock'] || $GP['products-using_stock'] || $GP['product_stock_count']) { ?>
								<li class="mm_products">
									<a class="dropmenu" href="#">
										<i class="fa fa-barcode"></i>
							...
							<?php if ($GP['purchases-index'] || $GP['purchases_order-index'] || $GP['purchase_request-index'] || $GP['purchases-expenses'] || $GP['purchases-return_list'] || $GP['purchases-return_list']) { ?>
								<li class="mm_purchases mm_purchases_request">
									<a class="dropmenu" href="#">
										<i class="fa fa-star"></i>
										<span class="text"> <?= lang('manage_purchases'); ?> 
