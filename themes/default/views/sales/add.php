...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		if (test2 == '1') {
			...
			//localStorage.removeItem('remove_s2');
      ...
      $(document).on('change', '#sldate', function (e) {
		...
		//$('#form').formValidation('enableFieldValidators', 'sldate', true);
		//$('#sldate').bootstrapValidator('revalidateField', 'sldate');
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4" id="so_ref" style="display:none;">
							<div class="form-group">
								<?= lang("so_no", "soref"); ?>
								<?php echo form_input('so_reference_no', $refer, 'class="form-control input-tip" id="soref" style="pointer-events:none;"'); ?>
								<?php echo form_hidden('delivery_id_update', $delivery_id, 'class="form-control input-tip" id="delivery_id_update"'); ?>
								<?php echo form_hidden('so_id', $sale_order->sale_id, 'class="form-control input-tip" id="so_id"'); ?>
									...
									<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php if ($Owner || $Admin || $GP['customers-add']) { ?><div class="input-group"><?php } ?>
                                                <?php
                                                echo form_input('customer_1', (isset($_POST['customer']) ? $_POST['customer'] : ($sale_order->company_name?$sale_order->company_name:$this->input->get('customer'))), 'id="slcustomer" data-placeholder="' . lang("select") . ' ' . lang("customer") . '" required="required" class="form-control input-tip" style="min-width:100%;"');
                                                ?>
